...
/**
 * Repository customize : Auteur.
 *
 * @author Smile Backend Generator
 *
 */
@Repository
public interface _AuteurRepository {
	default List<String> _generateCriteria(AuteurDto dto, HashMap<String, Object> param, Integer index, Locale locale) throws Exception {
