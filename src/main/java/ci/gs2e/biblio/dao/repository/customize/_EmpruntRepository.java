...
/**
 * Repository customize : Emprunt.
 *
 * @author Smile Backend Generator
 *
 */
@Repository
public interface _EmpruntRepository {
	default List<String> _generateCriteria(EmpruntDto dto, HashMap<String, Object> param, Integer index, Locale locale) throws Exception {
