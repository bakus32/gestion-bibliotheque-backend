...
/**
 * Repository customize : CategorieLivre.
 *
 * @author Smile Backend Generator
 *
 */
@Repository
public interface _CategorieLivreRepository {
	default List<String> _generateCriteria(CategorieLivreDto dto, HashMap<String, Object> param, Integer index, Locale locale) throws Exception {
