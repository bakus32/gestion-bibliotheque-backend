...
/**
 * Repository customize : RoleFonctionnalite.
 *
 * @author Smile Backend Generator
 *
 */
@Repository
public interface _RoleFonctionnaliteRepository {
	default List<String> _generateCriteria(RoleFonctionnaliteDto dto, HashMap<String, Object> param, Integer index, Locale locale) throws Exception {
